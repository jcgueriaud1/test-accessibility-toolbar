...
public class ShowComponentCreateLocationHandler implements MessageHandler {

    private final IdeIntegration ideIntegration;

    public ShowComponentCreateLocationHandler(IdeIntegration ideIntegration) {
    ...
    public String getCommandName() {
        return ComponentCommand.SHOW_COMPONENT_CREATE_LOCATION;
    }
}
